...
//locator in staff
    ...
    /*public ArrayList<String> getStaff(){
        ArrayList<String>the_staff= new ArrayList<String>();
        for (WebElement staffd: developerStaff ){
            the_staff.add(staffd.getText());
        }
        return the_staff;
    }*/
//Get Gender
    ...
    public String textFranqui(){
        return this.getText(finfields.get(5));
    }
